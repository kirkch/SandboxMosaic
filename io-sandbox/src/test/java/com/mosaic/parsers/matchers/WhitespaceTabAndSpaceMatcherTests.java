 ...
 *
 */
public class WhitespaceTabAndSpaceMatcherTests {
    ...
    @Test
    public void givenWordBlankWordWithNewLines_matchFromMidpointOfBlank_expectToStopAtNewLine() {
        CharBuffer buf = CharBuffer.wrap("Hello  \t\n\r  World");
        buf.position(7);

        MatchResult result = spaceMatcher.match(buf, true);

        assertMatch(result, 1, null);
