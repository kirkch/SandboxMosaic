...
//        List<ObjectNode> nextNodes = considerNextStep(c);
//
...
//        Map<String, List<KV<Character,ObjectNode>>> candidateNextSteps = fetchAllCandidateNextSteps();
//
...
//    }
//
//    private String prettyPrint( Map<String, List<KV<Character, ObjectNode>>> candidateNextSteps, String separator ) {
//        Set<Map.Entry<String, List<KV<Character, ObjectNode>>>> elements = MapUtils.toTreeMap(candidateNextSteps).entrySet();
//
...
//     */
//    private static final Formatter<Map.Entry<String, List<KV<Character,ObjectNode>>>> NEXT_STEPS_FORMATTER = new Formatter<Map.Entry<String, List<KV<Character,ObjectNode>>>>() {
//        public void write( Appendable buf, Map.Entry<String, List<KV<Character, ObjectNode>>> step ) throws IOException {
//            String             label      = step.getKey();
//            TreeSet<Character> characters = new TreeSet();
//
//            for ( KV<Character, ObjectNode> p : step.getValue() ) {
...
//    };
//
//    private Map<String, List<KV<Character,ObjectNode>>> fetchAllCandidateNextSteps() {
//        List<List<KV<Character,ObjectNode>>> allOutEdges = new ArrayList();
//
...
//                new Function1<KV<Character,ObjectNode>,String>() {
//                    public String invoke( KV<Character,ObjectNode> pair ) {
...
//     */
//    private List<ObjectNode> considerNextStep(char c) {
//        List<List<ObjectNode>> nextNodes = new ArrayList();
//        for ( ObjectNode n : currentNodes ) {
