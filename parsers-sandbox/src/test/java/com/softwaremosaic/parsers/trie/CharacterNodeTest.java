...
////        CharacterNode start     = new CharacterNode("l1");
////        start.appendRegexpIC( "hello" );
////
////        assertCanfetch( start, "hello" );
////        assertCanfetch( start, "Hello" );
////        assertCanfetch( start, "HeLlo" );
////        assertCanfetch( start, "HeLlO" );
////
////        assertEquals( 0, start.fetch("Heo").size() );
////    }
////
////    @Test
...
////        start.appendRegexpIC( "hello" );
////
////        CharacterNode n1 = start.fetch('h').get(0);
////        CharacterNode n2 = start.fetch('H').get(0);
////
////        assertSame(n1, n2);
////    }
//
...
////
////        Node n1 = start.fetch('h').get(0);
////        Node n2 = start.fetch('H').get(0);
////
////        assertSame( n1, n2 );
////    }
//
...
//
//
//    private void assertCanfetch( CharacterNode start, String path ) {
