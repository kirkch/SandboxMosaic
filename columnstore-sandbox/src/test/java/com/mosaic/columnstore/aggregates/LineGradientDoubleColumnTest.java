...
// EMPTY SOURCE COLUMN, CALC MA3
    ...
    public void givenEmptySourceColumn_expectExplanationForAnyRow_toBeZeroWithNoTouchedCells() {
        ...
        DoubleColumn price    = new DoubleColumnArray( system, "cost", "d", rowCount);
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
...
// ONE POINT SOURCE
    ...
    public void givenASinglePoint_() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 4 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
...
// TWO POINT SOURCE
    ...
    public void givenATwoPointsGoingUp() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 4, 5 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
    ...
    public void givenATwoPointsGoingSideways() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 4, 4 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
    ...
    public void givenATwoPointsGoingSlightlyUp() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 4, 4.15 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
    ...
    public void givenATwoPointsGoingSlightlyDown() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 4, 3 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
...
// THREE POINT SOURCE
    ...
    public void givenAThreePointsGoingUp() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 4, 5, 6 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
    ...
    public void givenAThreePointsGoingSideways() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 4.9, 5, 4.9 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
    ...
    public void givenAThreePointsGoingDown() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 6, 5, 4 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
...
// 4 point line
    ...
    public void givenFourPointsGoingDown_expectOnlyThreePointsToBeConsidered() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 101, 5, 4, 3 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 3 );
    ...
    public void givenFourPointsGoingUpUsingAllFourPoints_expectOnlyThreePointsToBeConsidered() {
        DoubleColumn price    = Columns.newDoubleColumn( system, "cost", "d", 1, 1.5, 2, 2.5 );
        DoubleColumn gradient = new LineGradientDoubleColumn( system, price, 4 );
