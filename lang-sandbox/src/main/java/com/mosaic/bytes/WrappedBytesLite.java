...
/**
 * A lite weight util for wrapping Bytes.  All it does is delegate every call off to the wrapped
 * instance.  No extra work is performed.
 */
public class WrappedBytesLite implements Bytes {
    private final Bytes delegate;


    public WrappedBytesLite( Bytes delegate ) {
